import { v as E, n as w, e as z, f as x } from "./validation-Cx6ESUpl.js";
import { a as Se } from "./validation-Cx6ESUpl.js";
import { jsx as s, jsxs as _ } from "react/jsx-runtime";
import { useRef as U, useEffect as M, useSyncExternalStore as D, useId as F, useState as R } from "react";
const O = 12;
function $(e, a) {
...
function ie(e) {
  return [e.name, e.sku, L(e.price, e.currency)].filter((a) => a.trim() !== "").join(" · ");
}
const H = () => ({
  mode: "search",
  query: "",
...
function q(e) {
  const { service: a, context: r, addressType: t } = e, i = e.debounceMs ?? 250, c = e.minQueryLength ?? 3;
  let n = {
  ...
  const m = (l) => {
    ...
    const g = ++d;
    m({ searching: !0 });
    const f = await a.searchAddresses(r, { text: l, addressType: t });
    if (g === d) {
      if (f.status === "error") {
  ...
  return {
    ...
    async init() {
      if (!r.identity.accountId) return;
      m({ loadingSaved: !0 });
      const l = await a.listSavedAddresses(r, { addressType: t });
      m({
        loadingSaved: !1,
    ...
    async selectSuggestion(l) {
      ...
      const g = await a.resolveAddress(r, { suggestionId: l });
    ...
    async submitManualAddress() {
      ...
      const g = await a.validateAddress(r, { address: o.draft, addressType: t });
...
function B(e) {
  const { service: a, context: r } = e, t = e.debounceMs ?? 250, i = e.loadCategories ?? !0;
  let c = {
  ...
  const d = (u) => {
    ...
    const u = ++v;
    d({ loading: !0 });
    const y = await a.searchProducts(r, {
      text: n.query.trim(),
      sort: n.sort,
      page: n.page,
      pageSize: n.pageSize,
  ...
  return {
    ...
    async init() {
      ...
      const [u] = await Promise.all([a.listCategories(r), m()]);
      d({
        loadingCategories: !1,
    ...
    async selectProduct(u) {
      const y = (f) => {
        var p;
        return d({ selected: f }), (p = c.onProductSelected) == null || p.call(c, f), { status: "success" };
      }, l = n.products.find((f) => f.id === u);
      if (l) return y(l);
      d({ resolvingProductId: u });
      const g = await a.getProduct(r, { productId: u });
...
function V(e) {
  const a = U(null);
  a.current ?? (a.current = q(e));
  const r = a.current, { onAddressSelected: t, onAddressChange: i } = e;
  return M(() => {
    r.setCallbacks({ onAddressSelected: t, onAddressChange: i });
  }, [r, t, i]), M(() => (r.init(), () => {
    r.dispose();
  }), [r]), { state: D(r.subscribe, r.getState, r.getState), controller: r };
}
const Q = {
  ...
  zip: "ZIP/Postal Code",
  country: "Country"
}, G = ["city", "state", "zip", "country"], j = ({ expanded: e }) => /* @__PURE__ */ s(
  "svg",
  {
...
function le(e) {
  const a = F(), [r, t] = R(!0), i = e.expanded ?? r, { state: c, controller: n } = V({
    service: e.service,
    context: e.context,
  ...
  }), o = e.title ?? Q[e.addressType], h = c.selected ? c.selected.street || c.selected.city || c.selected.state : "", v = () => {
    var m;
    const d = !i;
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ _("div", { className: "ec-address__header-meta", children: [
            ...
            /* @__PURE__ */ s(j, { expanded: i })
          ] })
        ]
      }
    ),
    i ? /* @__PURE__ */ _("div", { className: "ec-address__body", children: [
      c.errorMessage ? /* @__PURE__ */ s("div", { role: "alert", className: "ec-address__alert", children: /* @__PURE__ */ s("span", { children: c.errorMessage }) }) : null,
      c.selected ? /* @__PURE__ */ s("div", { className: "ec-address__radio-box", "data-testid": "ec-address-selected", children: /* @__PURE__ */ s("p", { className: "ec-address__radio-box-detail", children: x(c.selected) }) }) : null,
      c.savedAddresses.length > 0 && !c.selected ? /* @__PURE__ */ s("div", { className: "ec-address__saved", children: c.savedAddresses.map((d) => /* @__PURE__ */ _(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ s("p", { className: "ec-address__radio-box-detail", children: x(d.address) })
          ]
        },
        d.id
      )) }) : null,
      c.mode === "search" && !c.searchDegraded ? /* @__PURE__ */ _("div", { className: "ec-address__search", children: [
        ...
        c.searching ? /* @__PURE__ */ s("p", { className: "ec-address__hint", children: "Searching…" }) : null,
        c.suggestions.length > 0 ? /* @__PURE__ */ s("ul", { className: "ec-address__suggestions", children: c.suggestions.map((d) => /* @__PURE__ */ s("li", { children: /* @__PURE__ */ s(
          "button",
          {
            type: "button",
        ...
        "form",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s("div", { className: "ec-address__row", children: G.map((d) => /* @__PURE__ */ s(
              P,
              {
                field: d,
                idBase: a,
            ...
            /* @__PURE__ */ _("div", { className: "ec-address__actions", children: [
              c.searchDegraded ? /* @__PURE__ */ s("span", {}) : /* @__PURE__ */ s("button", { type: "button", className: "ec-address__link", onClick: () => n.setMode("search"), children: "Back to search" }),
              /* @__PURE__ */ s("button", { type: "submit", className: "ec-address__btn-primary", disabled: c.submitting, children: c.submitting ? "Validating…" : "Continue" })
            ] })
          ]
        }
      )
...
function P({ field: e, idBase: a, value: r, error: t, grow: i, onChange: c }) {
  return /* @__PURE__ */ _("div", { className: `ec-address__field${i ? " ec-address__field--grow" : ""}`, children: [
    /* @__PURE__ */ s("label", { htmlFor: `${a}-${e}`, children: X[e] }),
    /* @__PURE__ */ s("div", { className: "ec-address__input-wrapper", children: /* @__PURE__ */ s(
      "input",
      {
        id: `${a}-${e}`,
...
function K(e) {
  const a = U(null);
  a.current ?? (a.current = B(e));
  const r = a.current, { onProductSelected: t, onAddToCart: i } = e;
  return M(() => {
    r.setCallbacks({ onProductSelected: t, onAddToCart: i });
  }, [r, t, i]), M(() => (r.init(), () => {
    r.dispose();
  }), [r]), { state: D(r.subscribe, r.getState, r.getState), controller: r };
}
const Z = () => /* @__PURE__ */ s("svg", { className: "ec-catalog__search-icon", viewBox: "0 0 24 24", width: "20", height: "20", "aria-hidden": "true", children: /* @__PURE__ */ s(
  "path",
  {
    d: "M15.5 14h-.79l-.28-.27a6.5 6.5 0 1 0-.7.7l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0A4.5 4.5 0 1 1 14 9.5 4.5 4.5 0 0 1 9.5 14z",
    fill: "currentColor"
  }
) }), Y = () => /* @__PURE__ */ s("svg", { className: "ec-catalog__not-found-icon", viewBox: "0 0 24 24", width: "17", height: "17", "aria-hidden": "true", children: /* @__PURE__ */ s(
  "path",
  {
    d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z",
    fill: "currentColor"
  }
) }), I = ({ direction: e }) => /* @__PURE__ */ s("svg", { viewBox: "0 0 24 24", width: "20", height: "20", "aria-hidden": "true", children: e === "back" ? /* @__PURE__ */ s("path", { d: "M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z", fill: "currentColor" }) : /* @__PURE__ */ s("path", { d: "M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z", fill: "currentColor" }) });
function J(e, a) {
  return a <= 7 ? Array.from({ length: a }, (r, t) => t + 1) : e <= 4 ? [1, 2, 3, 4, "...", a - 1, a] : e >= a - 3 ? [1, 2, "...", a - 3, a - 2, a - 1, a] : [1, "...", e - 1, e, e + 1, "...", a];
}
function ue(e) {
  const a = F(), r = e.layout ?? "horizontal", { state: t, controller: i } = K({
    service: e.service,
    context: e.context,
    onProductSelected: e.onProductSelected,
    onAddToCart: e.onAddToCart,
    ...
    loadCategories: !1
  }), c = t.loading && t.products.length === 0, n = t.loaded && !t.loading && t.products.length === 0 && !t.degraded;
  return /* @__PURE__ */ _("section", { className: "ec-catalog", children: [
    ...
    ] }) : /* @__PURE__ */ s("ul", { className: `ec-catalog__items ec-catalog__items--${r}`, "data-layout": r, children: c ? Array.from({ length: 3 }, (o, h) => /* @__PURE__ */ _("li", { className: `ec-catalog__card ec-catalog__card--${r}`, "aria-hidden": "true", children: [
    ...
    t.pageCount > 1 ? /* @__PURE__ */ s("nav", { className: "ec-catalog__pagination-wrap", "aria-label": "Catalog pages", children: /* @__PURE__ */ _("ul", { className: "ec-catalog__pagination", children: [
      /* @__PURE__ */ s("li", { children: /* @__PURE__ */ s(
        "button",
        {
          ...
          children: /* @__PURE__ */ s(I, { direction: "back" })
        }
      ) }),
      J(t.page, t.pageCount).map(
      ...
      /* @__PURE__ */ s("li", { children: /* @__PURE__ */ s(
        "button",
        {
          ...
          onClick: () => i.setPage(t.page + 1),
          children: /* @__PURE__ */ s(I, { direction: "forward" })
        }
      ) })
    ] }) }) : null
  ] });
}
function ee({ product: e, layout: a, onOpen: r, onAddToCart: t }) {
  return /* @__PURE__ */ _("li", { className: `ec-catalog__card ec-catalog__card--${a}`, "data-in-stock": e.inStock, children: [
    ...
    /* @__PURE__ */ _("div", { className: "ec-catalog__card-text", children: [
      /* @__PURE__ */ s("button", { type: "button", className: "ec-catalog__card-title", onClick: r, children: e.name }),
    ...
    /* @__PURE__ */ _("div", { className: "ec-catalog__card-attributes", children: [
      ...
      /* @__PURE__ */ _("div", { className: "ec-catalog__card-field", children: [
        ...
        /* @__PURE__ */ s("span", { className: "ec-catalog__card-field-value", children: L(e.price, e.currency) })
      ] })
    ] }),
...
function ge(e) {
  return {
    async searchAddresses(a, r) {
      try {
        return await e(b.searchAddresses, { context: a, ...r });
      } catch (t) {
        return { status: "error", errorMessage: A(t), suggestions: [] };
      }
    },
    async resolveAddress(a, r) {
      try {
        return await e(b.resolveAddress, { context: a, ...r });
      } catch (t) {
        return { status: "error", errorMessage: A(t) };
      }
    },
    async validateAddress(a, r) {
      try {
        return await e(b.validateAddress, { context: a, ...r });
      } catch (t) {
        return { status: "error", errorMessage: A(t) };
      }
    },
    async listSavedAddresses(a, r) {
      try {
        return await e(b.listSavedAddresses, { context: a, ...r });
      } catch (t) {
...
}, k = (e) => e instanceof Error ? e.message : "Catalog service request failed";
function me(e) {
  return {
    async searchProducts(a, r) {
      try {
        return await e(N.searchProducts, { context: a, ...r });
      } catch (t) {
        return { status: "error", errorMessage: k(t), products: [], totalCount: 0 };
      }
    },
    async getProduct(a, r) {
      try {
        return await e(N.getProduct, { context: a, ...r });
      } catch (t) {
        return { status: "error", errorMessage: k(t) };
      }
    },
    async listCategories(a) {
      try {
        return await e(N.listCategories, { context: a });
      } catch (r) {
        return { status: "error", errorMessage: k(r), categories: [] };
      }
    }
  };
}
...
function he(e = {}) {
  const a = e.fixtures ?? se, r = e.savedAddresses ?? te, t = () => new Promise((i) => setTimeout(i, e.latencyMs ?? 0));
  return {
    ...
    async resolveAddress(i, c) {
      ...
      const n = a.find((o) => o.suggestion.id === c.suggestionId);
    ...
    async validateAddress(i, c) {
      ...
      const n = E(c.address, c.addressType);
    ...
    async listSavedAddresses(i, c) {
      return await t(), i.identity.accountId ? { status: "success", addresses: r } : { status: "success", addresses: [] };
    }
  };
}
function fe(e = {}) {
...
const S = (e) => "data:image/svg+xml;utf8," + encodeURIComponent(
  ...
  switch (a) {
    case "price-asc":
      return r.sort((t, i) => t.price - i.price);
    case "price-desc":
      return r.sort((t, i) => i.price - t.price);
    case "name":
      return r.sort((t, i) => t.name.localeCompare(i.name));
    case "relevance":
      return r;
  }
};
function _e(e = {}) {
  const a = e.products ?? re, r = e.categories ?? ae, t = () => new Promise((i) => setTimeout(i, e.latencyMs ?? 0));
  return {
    async searchProducts(i, c) {
      ...
      const n = c.text.trim().toLowerCase(), o = ce(
        a.filter((v) => c.categoryId && v.categoryId !== c.categoryId ? !1 : n ? [v.name, v.description, v.sku].some(
    ...
    async getProduct(i, c) {
      ...
      const n = a.find((o) => o.id === c.productId);
      return n ? { status: "success", product: n } : { status: "error", errorMessage: `mock: unknown product ${c.productId}` };
    },
    async listCategories(i) {
      return await t(), e.failCategories ? { status: "error", errorMessage: "mock: categories unavailable", categories: [] } : { status: "success", categories: r };
    }
  };
}
export {
  ...
  le as AddressPanel,
  N as CATALOG_EXECUTOR_METHODS,
  ue as CatalogPanel,
  O as DEFAULT_CATALOG_PAGE_SIZE,
  q as createAddressController,
  B as createCatalogController,
  ge as createExecutorAddressService,
  me as createExecutorCatalogService,
  he as createMockAddressService,
  _e as createMockCatalogService,
  fe as createMockRuntimeContext,
  z as emptyAddress,
  x as formatAddressLine,
  L as formatPrice,
  ie as formatProductLine,
  w as normalizeAddress,
  Se as normalizeCountry,
  $ as pageCountOf,
  V as useAddressController,
  K as useCatalogController,
  E as validateAddressFormat
};
